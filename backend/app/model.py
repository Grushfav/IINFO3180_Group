...
class Profile(db.Model):
    ...
    preferred_min_age = db.Column(db.SmallInteger, default=18)
    preferred_max_age = db.Column(db.SmallInteger, default=60)
    max_distance_km = db.Column(db.SmallInteger, default=50)
