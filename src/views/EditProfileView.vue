        ...
        <div class="form-section">
          ...
          <div class="form-row">
            <div class="field-group">
              ...
              <input v-model.number="form.preferredMinAge" type="number" min="18" max="99" class="field-input" />
            </div>
            <div class="field-group">
              <label class="field-label">Preferred Max Age</label>
              <input v-model.number="form.preferredMaxAge" type="number" min="18" max="99" class="field-input" />
            </div>
          </div>
          <div class="form-row">
            <div class="field-group">
              <label class="field-label">Max Distance (km)</label>
              <input v-model.number="form.maxDistanceKm" type="number" min="1" max="500" class="field-input" />
            </div>
            <div class="field-group">
              <label class="field-label">Relationship Goal</label>
              <input v-model="form.relationshipGoal" type="text" class="field-input" placeholder="e.g. long-term" />
            </div>
          </div>
          <div class="form-row">
            <div class="field-group">
              <label class="field-label">Latitude</label>
              <input :value="form.latitude ?? ''" type="text" class="field-input" readonly />
            </div>
            <div class="field-group">
              <label class="field-label">Longitude</label>
              <input :value="form.longitude ?? ''" type="text" class="field-input" readonly />
            </div>
          </div>
          <button type="button" class="btn-geo" @click="useCurrentLocation">Use Current Location</button>
...
function useCurrentLocation() {
  ...
  navigator.geolocation.getCurrentPosition(
    ...
    () => {
      errorMsg.value = 'Could not access your location. Please allow location permissions.'
    }
  )
}
...
async function handleSave() {
  ...
  if (form.value.preferredMinAge > form.value.preferredMaxAge) {
    errorMsg.value = 'Preferred min age cannot be greater than preferred max age.'
    return
  }
...
onMounted(async () => {
  ...
  if (user) {
    Object.assign(form.value, {
      ...
      preferredMinAge: user.preferredMinAge ?? 18,
      preferredMaxAge: user.preferredMaxAge ?? 60,
